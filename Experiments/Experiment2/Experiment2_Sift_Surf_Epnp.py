...
for testImage_path in testImages_paths:
    ...
    #file_path = "Experiments/Experiment2/Outputs/SIFT_EPnP/NLC_" + fileName
    file_path = "Experiments/Experiment2/Outputs/SIFT_EPnP/HLC_" + fileName
    ...
    #Storing results
    projected_image = Utils.Project_skeleton_on_image(undistorted_image, K_test,R,T)
    #file_path = "Experiments/Experiment2/Outputs/SURF_EPnP/NLC_" + fileName
    file_path = "Experiments/Experiment2/Outputs/SURF_EPnP/HLC_" + fileName
    cv2.imwrite(file_path, cv2.resize(projected_image, (0, 0), fx=0.5, fy=0.5))
